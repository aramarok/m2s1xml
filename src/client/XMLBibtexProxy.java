...
public class XMLBibtexProxy implements client.XMLBibtex {
  ...
  private void _initXMLBibtexProxy() {
    try {
      ...
      if (xMLBibtex != null) {
        if (_endpoint != null)
          ((javax.xml.rpc.Stub)xMLBibtex)._setProperty("javax.xml.rpc.service.endpoint.address", _endpoint);
        else
          _endpoint = (String)((javax.xml.rpc.Stub)xMLBibtex)._getProperty("javax.xml.rpc.service.endpoint.address");
      }
  ...
  public boolean add(java.lang.String bibtexEntryId, java.lang.String bibtexEntryType, java.util.HashMap bittexEntryDetails) throws java.rmi.RemoteException{
    if (xMLBibtex == null)
      _initXMLBibtexProxy();
    return xMLBibtex.add(bibtexEntryId, bibtexEntryType, bittexEntryDetails);
  }
