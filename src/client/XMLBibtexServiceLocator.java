...
public class XMLBibtexServiceLocator extends org.apache.axis.client.Service implements client.XMLBibtexService {
    ...
    public XMLBibtexServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public client.XMLBibtex getXMLBibtex(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            client.XMLBibtexSoapBindingStub _stub = new client.XMLBibtexSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (client.XMLBibtex.class.isAssignableFrom(serviceEndpointInterface)) {
                client.XMLBibtexSoapBindingStub _stub = new client.XMLBibtexSoapBindingStub(new java.net.URL(XMLBibtex_address), this);
                _stub.setPortName(getXMLBibtexWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://m2s1xml", "XMLBibtexService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://m2s1xml", "XMLBibtex"));
        }
